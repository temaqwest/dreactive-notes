...
const NoteContent = ({noteToShow}) => {
        function render() {
            if (isEmpty()) {
                ...
                return (
                    <div className={classes.note__contentEditable}>
                        <span className={classes.contentDatetime}> {noteToShow.date} </span>
                        <h1 className={classes.contentTitle}> {noteToShow.title} </h1>
                        <p className={classes.contentParagraph}> {noteToShow.content} </p>
                    </div>
                )
            }
        }
